...
The implementation of the replay buffer can be found [here] (https://github.com/smfarrukh82/DeepReinforcementLearning-Navigation/blob/master/dqn_agent.py)  in the `agent.py` file of the source code.
